...
# 69 which means postitive relationship between height and weight, it doesn't say anything about strength
...
0.995^2 # also equal R^2 value in this case (Simple Linear Regression), the closer it is to 1 the better the model

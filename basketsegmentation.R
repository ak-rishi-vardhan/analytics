...
#confidence of a in b is no of times a and b were bought together divided by 

inspect(rulesc[1:5])
rulesl <- sort (rules, by="lift", decreasing=TRUE)

#if lift is 1 it means there is a strong correlation between the two products. If negative, it means increase of one
#results in the decrease of the other

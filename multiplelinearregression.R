...
#Fstatistic only look at P value, R^2 if .75 means 75% variation of y is explained by changes in x
#fstatistic value comes from the ANOVA test
#if there is no star near values it means the model is not significant
